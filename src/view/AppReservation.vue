...
export default {
    ...
    methods: {
        getToday() {
            const dayBtn = document.querySelector('.day_txt');
            ...
            if (dayBtn.textContent == 'Domani') {
                const obJDate = new Date()
                this.date = new Date(obJDate.getFullYear(), obJDate.getMonth(), obJDate.getDate() + 1);
            } else {
                this.date = new Date();
            }
